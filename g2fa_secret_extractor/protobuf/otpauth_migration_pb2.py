...
# source: protobuf/otpauth_migration.proto
...
_PAYLOAD_OTPPARAMETERS = _descriptor.Descriptor(
  name='OtpParameters',
  full_name='Payload.OtpParameters',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='secret', full_name='Payload.OtpParameters.secret', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='Payload.OtpParameters.name', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='issuer', full_name='Payload.OtpParameters.issuer', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='algorithm', full_name='Payload.OtpParameters.algorithm', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='digits', full_name='Payload.OtpParameters.digits', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='Payload.OtpParameters.type', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='counter', full_name='Payload.OtpParameters.counter', index=6,
...
_PAYLOAD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='otp_parameters', full_name='Payload.otp_parameters', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='version', full_name='Payload.version', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='batch_size', full_name='Payload.batch_size', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='batch_index', full_name='Payload.batch_index', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='batch_id', full_name='Payload.batch_id', index=4,
...
Payload = _reflection.GeneratedProtocolMessageType('Payload', (_message.Message,), {
  ...
  'OtpParameters' : _reflection.GeneratedProtocolMessageType('OtpParameters', (_message.Message,), {
    ...
    '__module__' : 'protobuf.otpauth_migration_pb2'
    # @@protoc_insertion_point(class_scope:Payload.OtpParameters)
    })
  ,
  'DESCRIPTOR' : _PAYLOAD,
  '__module__' : 'protobuf.otpauth_migration_pb2'
